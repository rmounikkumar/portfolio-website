              ...
              <div className="grid md:grid-cols-[1fr_1.2fr] gap-10">
                ...
                <div className="flex flex-col justify-between">
                  ...
                  <div className="flex gap-3 mt-8">
                    <a href="https://ecommerce-store-shop-easy.vercel.app/" target="_blank" rel="noopener noreferrer" className="group/btn flex items-center justify-center rounded-full bg-white p-2 shadow-lg transition-all duration-500 hover:bg-white/90 hover:scale-105 hover:border hover:border-white/60"><Image src="/presentation.png" alt="Live Demo" width={40} height={40} className="w-10 h-10 shrink-0 rounded-full" /></a>
            ...
            <div className="card p-8 md:p-12 group">
              ...
              <div className="grid md:grid-cols-[1fr_1.2fr] gap-10">
                ...
                <div className="flex flex-col justify-between">
                  ...
                  <div className="flex gap-3 mt-8">
                    <a href="https://eduteck.onrender.com" target="_blank" rel="noopener noreferrer" className="group/btn flex items-center justify-center rounded-full bg-white p-2 shadow-lg transition-all duration-500 hover:bg-white/90 hover:scale-105 hover:border hover:border-white/60"><Image src="/presentation.png" alt="Live Demo" width={40} height={40} className="w-10 h-10 shrink-0 rounded-full" /></a>
            ...
            <div className="card p-8 md:p-12 mb-10 group">
              ...
              <div className="grid md:grid-cols-[1fr_1.2fr] gap-10">
                ...
                <div className="flex flex-col justify-between">
                  ...
                  <div className="flex gap-3 mt-8">
                    <a href="https://sms-security-gateway.onrender.com" target="_blank" rel="noopener noreferrer" className="group/btn flex items-center justify-center rounded-full bg-white p-2 shadow-lg transition-all duration-500 hover:bg-white/90 hover:scale-105 hover:border hover:border-white/60"><Image src="/presentation.png" alt="Live Demo" width={40} height={40} className="w-10 h-10 shrink-0 rounded-full" /></a>
            ...
            <div className="card p-8 md:p-12 mb-10 group">
              ...
              <div className="grid md:grid-cols-[1fr_1.2fr] gap-10">
                ...
                <div className="flex flex-col justify-between">
                  ...
                  <div className="flex gap-3 mt-8">
                    <a href="https://github.com/rmounikkumar/wavebeat/releases" target="_blank" rel="noopener noreferrer" className="group/btn flex items-center justify-center gap-2 rounded-full bg-white px-5 py-2 text-black text-xs font-[family-name:var(--font-mono)] tracking-wider transition-all duration-500 hover:bg-white/90"><Image src="/presentation.png" alt="" width={32} height={32} className="w-8 h-8 shrink-0 rounded-full" /> Get APK</a>
            ...
            <div className="card p-8 md:p-12 group">
              ...
              <div className="grid md:grid-cols-[1fr_1.2fr] gap-10">
                ...
                <div className="flex flex-col justify-between">
                  ...
                  <div className="flex gap-3 mt-8">
                    <a href="https://rmounikkumar.github.io/pocketpuzzle" target="_blank" rel="noopener noreferrer" className="group/btn flex items-center justify-center rounded-full bg-white p-2 shadow-lg transition-all duration-500 hover:bg-white/90 hover:scale-105 hover:border hover:border-white/60"><Image src="/presentation.png" alt="Live Demo" width={40} height={40} className="w-10 h-10 shrink-0 rounded-full" /></a>
