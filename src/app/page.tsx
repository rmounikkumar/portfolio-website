              ...
              <div className="grid md:grid-cols-[1fr_1.2fr] gap-10">
                ...
                <div className="flex flex-col justify-between">
                  ...
                  <div className="flex gap-3 mt-8">
                    <a href="https://ecommerce-store-shop-easy.vercel.app/" target="_blank" rel="noopener noreferrer" className="group/btn flex items-center justify-center gap-2 border border-white/90 rounded-full px-6 py-2.5 text-white text-xs font-[family-name:var(--font-mono)] tracking-wider transition-all duration-500 bg-[#2563eb] hover:bg-[#1d4ed8] hover:border-white hover:shadow-[0_0_25px_rgba(37,99,235,0.45),0_0_50px_rgba(37,99,235,0.15)]"><Image src="/presentation.png" alt="" width={18} height={18} className="rounded-full bg-white/20 p-[2px] shrink-0" /> Live Demo <span className="transition-transform duration-500 group-hover/btn:translate-x-1">→</span></a>
                    <a href="https://github.com/rmounikkumar/ecommerce-store" target="_blank" rel="noopener noreferrer" className="group/btn flex items-center justify-center gap-2 border border-white rounded-full px-6 py-2.5 text-black text-xs font-[family-name:var(--font-mono)] tracking-wider transition-all duration-500 bg-white hover:bg-white/85 hover:border-white/85 hover:shadow-[0_0_25px_rgba(255,255,255,0.2)]"><svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4"><path d="M12 0C5.37 0 0 5.37 0 12c0 5.31 3.435 9.795 8.205 11.385.6.105.825-.255.825-.57 0-.285-.015-1.23-.015-2.235-3.015.555-3.795-.735-4.035-1.41-.135-.345-.72-1.41-1.23-1.695-.42-.225-1.02-.78-.015-.795.945-.015 1.62.87 1.845 1.23 1.08 1.815 2.805 1.305 3.495.99.105-.78.42-1.305.765-1.605-2.67-.3-5.46-1.335-5.46-5.925 0-1.305.465-2.385 1.23-3.225-.12-.3-.54-1.53.12-3.18 0 0 1.005-.315 3.3 1.23.96-.27 1.98-.405 3-.405s2.04.135 3 .405c2.295-1.56 3.3-1.23 3.3-1.23.66 1.65.24 2.88.12 3.18.765.84 1.23 1.905 1.23 3.225 0 4.605-2.805 5.625-5.475 5.925.435.375.81 1.095.81 2.22 0 1.605-.015 2.895-.015 3.3 0 .315.225.69.825.57A12.02 12.02 0 0024 12c0-6.63-5.37-12-12-12z" /></svg> GitHub <span className="transition-transform duration-500 group-hover/btn:translate-x-1">→</span></a>
                  </div>
                </div>
              </div>
            ...
            <div className="card p-8 md:p-12 group">
              ...
              <div className="grid md:grid-cols-[1fr_1.2fr] gap-10">
                ...
                <div className="flex flex-col justify-between">
                  ...
                  <div className="flex gap-3 mt-8">
                    <a href="https://eduteck.onrender.com" target="_blank" rel="noopener noreferrer" className="group/btn flex items-center justify-center gap-2 border border-white/90 rounded-full px-6 py-2.5 text-white text-xs font-[family-name:var(--font-mono)] tracking-wider transition-all duration-500 bg-[#2563eb] hover:bg-[#1d4ed8] hover:border-white hover:shadow-[0_0_25px_rgba(37,99,235,0.45),0_0_50px_rgba(37,99,235,0.15)]"><Image src="/presentation.png" alt="" width={18} height={18} className="rounded-full bg-white/20 p-[2px] shrink-0" /> Live Demo <span className="transition-transform duration-500 group-hover/btn:translate-x-1">→</span></a>
                    <a href="https://github.com/rmounikkumar/Eduteck-website" target="_blank" rel="noopener noreferrer" className="group/btn flex items-center justify-center gap-2 border border-white rounded-full px-6 py-2.5 text-black text-xs font-[family-name:var(--font-mono)] tracking-wider transition-all duration-500 bg-white hover:bg-white/85 hover:border-white/85 hover:shadow-[0_0_25px_rgba(255,255,255,0.2)]"><svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4"><path d="M12 0C5.37 0 0 5.37 0 12c0 5.31 3.435 9.795 8.205 11.385.6.105.825-.255.825-.57 0-.285-.015-1.23-.015-2.235-3.015.555-3.795-.735-4.035-1.41-.135-.345-.72-1.41-1.23-1.695-.42-.225-1.02-.78-.015-.795.945-.015 1.62.87 1.845 1.23 1.08 1.815 2.805 1.305 3.495.99.105-.78.42-1.305.765-1.605-2.67-.3-5.46-1.335-5.46-5.925 0-1.305.465-2.385 1.23-3.225-.12-.3-.54-1.53.12-3.18 0 0 1.005-.315 3.3 1.23.96-.27 1.98-.405 3-.405s2.04.135 3 .405c2.295-1.56 3.3-1.23 3.3-1.23.66 1.65.24 2.88.12 3.18.765.84 1.23 1.905 1.23 3.225 0 4.605-2.805 5.625-5.475 5.925.435.375.81 1.095.81 2.22 0 1.605-.015 2.895-.015 3.3 0 .315.225.69.825.57A12.02 12.02 0 0024 12c0-6.63-5.37-12-12-12z" /></svg> GitHub <span className="transition-transform duration-500 group-hover/btn:translate-x-1">→</span></a>
                  </div>
                </div>
              </div>
            ...
            <div className="card p-8 md:p-12 mb-10 group">
              ...
              <div className="grid md:grid-cols-[1fr_1.2fr] gap-10">
                ...
                <div className="flex flex-col justify-between">
                  ...
                  <div className="flex gap-3 mt-8">
                    <a href="https://sms-security-gateway.onrender.com" target="_blank" rel="noopener noreferrer" className="group/btn flex items-center justify-center gap-2 border border-white/90 rounded-full px-6 py-2.5 text-white text-xs font-[family-name:var(--font-mono)] tracking-wider transition-all duration-500 bg-[#2563eb] hover:bg-[#1d4ed8] hover:border-white hover:shadow-[0_0_25px_rgba(37,99,235,0.45),0_0_50px_rgba(37,99,235,0.15)]"><Image src="/presentation.png" alt="" width={18} height={18} className="rounded-full bg-white/20 p-[2px] shrink-0" /> Live Demo <span className="transition-transform duration-500 group-hover/btn:translate-x-1">→</span></a>
                    <a href="https://github.com/rmounikkumar/sms-security-gateway" target="_blank" rel="noopener noreferrer" className="group/btn flex items-center justify-center gap-2 border border-white rounded-full px-6 py-2.5 text-black text-xs font-[family-name:var(--font-mono)] tracking-wider transition-all duration-500 bg-white hover:bg-white/85 hover:border-white/85 hover:shadow-[0_0_25px_rgba(255,255,255,0.2)]"><svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4"><path d="M12 0C5.37 0 0 5.37 0 12c0 5.31 3.435 9.795 8.205 11.385.6.105.825-.255.825-.57 0-.285-.015-1.23-.015-2.235-3.015.555-3.795-.735-4.035-1.41-.135-.345-.72-1.41-1.23-1.695-.42-.225-1.02-.78-.015-.795.945-.015 1.62.87 1.845 1.23 1.08 1.815 2.805 1.305 3.495.99.105-.78.42-1.305.765-1.605-2.67-.3-5.46-1.335-5.46-5.925 0-1.305.465-2.385 1.23-3.225-.12-.3-.54-1.53.12-3.18 0 0 1.005-.315 3.3 1.23.96-.27 1.98-.405 3-.405s2.04.135 3 .405c2.295-1.56 3.3-1.23 3.3-1.23.66 1.65.24 2.88.12 3.18.765.84 1.23 1.905 1.23 3.225 0 4.605-2.805 5.625-5.475 5.925.435.375.81 1.095.81 2.22 0 1.605-.015 2.895-.015 3.3 0 .315.225.69.825.57A12.02 12.02 0 0024 12c0-6.63-5.37-12-12-12z" /></svg> GitHub <span className="transition-transform duration-500 group-hover/btn:translate-x-1">→</span></a>
                  </div>
                </div>
              </div>
            ...
            <div className="card p-8 md:p-12 mb-10 group">
              ...
              <div className="grid md:grid-cols-[1fr_1.2fr] gap-10">
                ...
                <div className="flex flex-col justify-between">
                  ...
                  <div className="flex gap-3 mt-8">
                    <a href="https://github.com/rmounikkumar/wavebeat/releases" target="_blank" rel="noopener noreferrer" className="group/btn flex items-center justify-center gap-2 border border-white/90 rounded-full px-6 py-2.5 text-white text-xs font-[family-name:var(--font-mono)] tracking-wider transition-all duration-500 bg-[#2563eb] hover:bg-[#1d4ed8] hover:border-white hover:shadow-[0_0_25px_rgba(37,99,235,0.45),0_0_50px_rgba(37,99,235,0.15)]"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-4 h-4 shrink-0"><path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" /></svg> Get APK <span className="transition-transform duration-500 group-hover/btn:translate-x-1">→</span></a>
                    <a href="https://github.com/rmounikkumar/wavebeat" target="_blank" rel="noopener noreferrer" className="group/btn flex items-center justify-center gap-2 border border-white rounded-full px-6 py-2.5 text-black text-xs font-[family-name:var(--font-mono)] tracking-wider transition-all duration-500 bg-white hover:bg-white/85 hover:border-white/85 hover:shadow-[0_0_25px_rgba(255,255,255,0.2)]"><svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4"><path d="M12 0C5.37 0 0 5.37 0 12c0 5.31 3.435 9.795 8.205 11.385.6.105.825-.255.825-.57 0-.285-.015-1.23-.015-2.235-3.015.555-3.795-.735-4.035-1.41-.135-.345-.72-1.41-1.23-1.695-.42-.225-1.02-.78-.015-.795.945-.015 1.62.87 1.845 1.23 1.08 1.815 2.805 1.305 3.495.99.105-.78.42-1.305.765-1.605-2.67-.3-5.46-1.335-5.46-5.925 0-1.305.465-2.385 1.23-3.225-.12-.3-.54-1.53.12-3.18 0 0 1.005-.315 3.3 1.23.96-.27 1.98-.405 3-.405s2.04.135 3 .405c2.295-1.56 3.3-1.23 3.3-1.23.66 1.65.24 2.88.12 3.18.765.84 1.23 1.905 1.23 3.225 0 4.605-2.805 5.625-5.475 5.925.435.375.81 1.095.81 2.22 0 1.605-.015 2.895-.015 3.3 0 .315.225.69.825.57A12.02 12.02 0 0024 12c0-6.63-5.37-12-12-12z" /></svg> GitHub <span className="transition-transform duration-500 group-hover/btn:translate-x-1">→</span></a>
                  </div>
                </div>
              </div>
            ...
            <div className="card p-8 md:p-12 group">
              ...
              <div className="grid md:grid-cols-[1fr_1.2fr] gap-10">
                ...
                <div className="flex flex-col justify-between">
                  ...
                  <div className="flex gap-3 mt-8">
                    <a href="https://rmounikkumar.github.io/pocketpuzzle" target="_blank" rel="noopener noreferrer" className="group/btn flex items-center justify-center gap-2 border border-white/90 rounded-full px-6 py-2.5 text-white text-xs font-[family-name:var(--font-mono)] tracking-wider transition-all duration-500 bg-[#2563eb] hover:bg-[#1d4ed8] hover:border-white hover:shadow-[0_0_25px_rgba(37,99,235,0.45),0_0_50px_rgba(37,99,235,0.15)]"><Image src="/presentation.png" alt="" width={18} height={18} className="rounded-full bg-white/20 p-[2px] shrink-0" /> Live Demo <span className="transition-transform duration-500 group-hover/btn:translate-x-1">→</span></a>
                    <a href="https://github.com/rmounikkumar/pocketpuzzle" target="_blank" rel="noopener noreferrer" className="group/btn flex items-center justify-center gap-2 border border-white rounded-full px-6 py-2.5 text-black text-xs font-[family-name:var(--font-mono)] tracking-wider transition-all duration-500 bg-white hover:bg-white/85 hover:border-white/85 hover:shadow-[0_0_25px_rgba(255,255,255,0.2)]"><svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4"><path d="M12 0C5.37 0 0 5.37 0 12c0 5.31 3.435 9.795 8.205 11.385.6.105.825-.255.825-.57 0-.285-.015-1.23-.015-2.235-3.015.555-3.795-.735-4.035-1.41-.135-.345-.72-1.41-1.23-1.695-.42-.225-1.02-.78-.015-.795.945-.015 1.62.87 1.845 1.23 1.08 1.815 2.805 1.305 3.495.99.105-.78.42-1.305.765-1.605-2.67-.3-5.46-1.335-5.46-5.925 0-1.305.465-2.385 1.23-3.225-.12-.3-.54-1.53.12-3.18 0 0 1.005-.315 3.3 1.23.96-.27 1.98-.405 3-.405s2.04.135 3 .405c2.295-1.56 3.3-1.23 3.3-1.23.66 1.65.24 2.88.12 3.18.765.84 1.23 1.905 1.23 3.225 0 4.605-2.805 5.625-5.475 5.925.435.375.81 1.095.81 2.22 0 1.605-.015 2.895-.015 3.3 0 .315.225.69.825.57A12.02 12.02 0 0024 12c0-6.63-5.37-12-12-12z" /></svg> GitHub <span className="transition-transform duration-500 group-hover/btn:translate-x-1">→</span></a>
                  </div>
                </div>
              </div>
